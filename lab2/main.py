...
from algorithms import (calc_nearest_neighbor_tour, calc_in_order_tour, calc_furthest_neighbor_tour, calc_EA_tour, calc_HC_tour)
...
def print_results_from_tsp_path(call_args, tsp_path):
    ...
    if call_args.need_HC:
        print("HC LENGTH:                {}"
              .format(calc_HC_tour(tsp)))

    if call_args.need_EA:
        print("EA LENGTH:                {}"
              .format(calc_EA_tour(tsp)))
